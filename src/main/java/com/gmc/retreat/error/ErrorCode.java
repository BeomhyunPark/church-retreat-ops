...
public enum ErrorCode {
    ...
    RETREAT_NOT_FOUND(HttpStatus.NOT_FOUND, "Retreat was not found."),
    CURRENT_RETREAT_ALREADY_EXISTS(HttpStatus.CONFLICT, "A current retreat already exists."),
    REGISTRATION_NOT_OPEN(HttpStatus.CONFLICT, "Retreat registration is not open."),
    INVALID_RETREAT_STATUS_TRANSITION(HttpStatus.CONFLICT, "Retreat status transition is not allowed."),
    PARTICIPATION_OPTION_NOT_FOUND(HttpStatus.NOT_FOUND, "Participation option was not found."),
    DUPLICATE_PARTICIPATION_OPTION(HttpStatus.CONFLICT, "Participation option already exists."),
