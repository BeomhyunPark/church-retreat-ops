...
// ) {
// return ApiResponse.success(communityService.createMiddleGroup(admin,
// request));
// }
...
// @Valid @RequestBody ChurchMiddleGroupRequest request
// ) {
// return ApiResponse.success(communityService.updateMiddleGroup(admin, id,
// request));
// }
...
// ) {
// return ApiResponse.success(communityService.updateMiddleGroupActive(admin,
// id, request));
// }
...
// ) {
// return ApiResponse.success(communityService.findCells(admin, middleGroupId,
// active));
// }
...
// @Valid @RequestBody ActiveUpdateRequest request
// ) {
// return ApiResponse.success(communityService.updateCellActive(admin, id,
// request));
// }
